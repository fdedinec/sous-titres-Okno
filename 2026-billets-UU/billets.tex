...
\newcommand{\ShortDescription}{\foreignlanguage{russian}{У}+\foreignlanguage{russian}{У}\\\small 14/06/2026}
\newcommand{\Description}{
  \em Club Lycorn\\
  \large\bf\foreignlanguage{russian}{Учитель} + \foreignlanguage{russian}{Ученик}\\
  \small 14/06/2026, 15h00\\ Espace Tonkin, Av. Salvador Allende, Villeurbanne
}
