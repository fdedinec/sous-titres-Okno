...
screen_size = 2100,1200 # for our good old Acer 800x600 projo
...
def main(filename):
    ...
    def display(i):
        ...
        for line in phrase:
            ...
            text_rect = text.get_rect(midleft=(screen.get_width()/2-300, screen.get_height()/2 + line_height*(y-2-vertical_offset) )) 
            y+=1
